<template>
  <div>
    <y-shelf title="我的订单"><!--Vue插槽相关的知识-->
      <span slot="right"><span>hello world</span></span>
      <!--<span slot='right'就相当于是组件y-shelf 里div元素 slot元素属性为name='right'占位符<div>
        <slot name="right"></slot>
      </div>
      -->
      <div slot="content">
        <div v-loading="loading" element-loading-text="加载中..." v-if="orderList.length" style="min-height: 10vw;">
          <!--<el-table border :data="orderList" :default-sort="{prop: 'time', order: 'descending'}" stripe
                    style="width: 90%">
            <el-table-column sortable prop="orderId" label="订单号" align="center"></el-table-column>
            <el-table-column sortable prop="payType" label="单价" align="center"></el-table-column>
            <el-table-column sortable prop="money" label="数量" align="center"></el-table-column>
            <el-table-column sortable prop="info" label="实付金额" align="center"></el-table-column>
                ...
                <div class="cart-l" :class="{bt:j>0}">
                  <div class="car-l-l">
                    <div class="img-box"><a @click="goodsDetails(good.productId)"><img :src="good.productImg"
                                                                                       alt=""></a></div>
                    <div class="ellipsis"><a style="color: #626262;" @click="goodsDetails(good.productId)">{{good.productName}}</a>
                    </div>
                  </div>
                  <div class="cart-l-r">
