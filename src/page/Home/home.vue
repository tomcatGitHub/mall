<template>
  <div class="home">
    ...
    做购物车动画需理解offsetX clientX layerX screenX  pageX X这几个元素之间的区别
    -->
    <div v-loading="loading" element-loading-text="数据加载中...,请稍候" style="min-height: 35vw;" v-if="!error">
      <div class="banner">
        <div class="bg" ref="bg"
  ...
  export default {
    ...
    methods: {
      ...
      bgMove (dom, eve) {
        ...
        X = mouseX - (bgOpt.w / 2)
        Y = bgOpt.h / 2 - mouseY
        dom.style['transform'] = `rotateY(${X / 50}deg) rotateX(${Y / 50}deg)` // 模板表达式比字符串拼接更有效
